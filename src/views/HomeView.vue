                  ...
                  <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12">
                      <div class="single-tab-select-box">
                        ...
                        <div class="travel-select-icon">
                          <select v-model="dest1" class="form-control ">

                              <option disabled value="">enter your destination country</option><!-- /.option-->
                        ...
                        <div class="travel-select-icon">
                          <select v-model="dest2" class="form-control ">

                              <option disabled value=""> enter your destination location</option><!-- /.option-->
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-4">
                      <div class="single-tab-select-box">
                        ...
                        <div class="travel-check-icon">
                          <form action="#">
                            <input v-model="chin" type="text" name="check_in" class="form-control" data-toggle="datepicker" placeholder="12 -01 - 2017 ">
                          </form>
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-4">
                      <div class="single-tab-select-box">
                        ...
                        <div class="travel-check-icon">
                          <form action="#">
                            <input v-model="chout" type="text" name="check_out" class="form-control"  data-toggle="datepicker" placeholder="22 -01 - 2017 ">
                          </form>
                        </div><!-- /.travel-check-icon -->
                      </div><!--/.single-tab-select-box-->
                    </div><!--/.col-->
                              ...
                              <div class="info_widget">
                                <div class="price_filter">
                                  ...
                                  <div class="price_slider_amount">
                                    <input v-model="amount" type="text" id="amount" name="price" readonly placeholder="Add Your Price" />
