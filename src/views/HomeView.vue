                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                          <div class="single-tab-select-box">
                            ...
                            <div class="travel-select-icon">
                              <select v-model="dest1" v-on:change="dest1Change" class="form-control">
                                <option value="">
                                ...
                                <!-- /.option--></select
                              ><!-- /.select-->
                              <span class="text-danger">{{ dest1Error }}</span>
                            </div>
                            <!-- /.travel-select-icon -->

                            <div class="travel-select-icon">
                              <select v-model="dest2" v-on:change="dest2Change" class="form-control">
                                <option value="">
                                ...
                                <!-- /.option--></select
                              ><!-- /.select-->
                              <span class="text-danger">{{ dest2Error }}</span>
                            </div>
                            <!-- /.travel-select-icon -->
                          </div>
        ...
        <div class="service-counter text-center">
          <div class="col-md-4 col-sm-4">
            <div class="single-service-box">
              <div class="service-img">
                <img
                  src="/src/assets/images/service/s1.png"
                  alt="service-icon"
                />
              </div>
              <!--/.service-img-->
          ...
          <div class="col-md-4 col-sm-4">
            <div class="single-service-box">
              <div class="service-img">
                <img
                  src="/src/assets/images/service/s2.png"
                  alt="service-icon"
                />
              </div>
              <!--/.service-img-->
          ...
          <div class="col-md-4 col-sm-4">
            <div class="single-service-box">
              <div class="statistics-img">
                <img
                  src="/src/assets/images/service/s3.png"
                  alt="service-icon"
                />
              </div>
              <!--/.service-img-->
